...
/**
 * This program will ask the user to enter 3 points and will calculate the
...
public class Origin {
    public static void main(String[] args) {
        // Constants are flexible if we ever want to check proximity to another
        // coordinates.
        final int X_BASE = 0;
        final int Y_BASE = 0;
        ...
        // Assigning the first input's calculation since there is nothing initialized to
        // _distance variable.
        ...
        // Using math equation to calculate if second input's distance from base is less
        // than prev distance.
        ...
        // Using math equation to calculate if third input's distance from base is less
        // than prev distance.
        ...
        System.out.printf("The nearest point to the origin is (" + nearest_x + "," + nearest_y + ")");
